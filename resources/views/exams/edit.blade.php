                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('exam.update', $exam->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ $exam->date }}" required autocomplete="date" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="note" type="text" class="form-control @error('note') is-invalid @enderror" name="note" required autocomplete="note" autofocus>{{ $exam->note }}</textarea>
