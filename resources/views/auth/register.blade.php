        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header flex-fill d-flex text-center p-0 m-0">
                    <div class="flex-fill p-2 login-btn">
                        <a type="button" class="btn text-center" href="{{ route('login') }}">
                            {{ __('Login') }}</a>
                    </div>
                    <div class="flex-fill bg-success p-2">
                        <a type="button" class="btn text-center text-white" href="{{ route('register') }}">
                            {{ __('Register') }}</a>
                    </div>
                </div>
