    ...
    <div class="d-flex flex-column p-3 text-white bg-dark">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
                ...
                <a href="#user" data-toggle="collapse" aria-expanded="false" class="arrow-toggle {{ Request::is('profile') ? 'active' : '' }} nav-link link-dark">
                    @auth
                        <div class="form-group d-flex justify-content-around align-items-center">
                            <img src="{{ Auth::user()->getFirstMediaUrl('avatars', 'thumb') ? Auth::user()->getFirstMediaUrl('avatars', 'thumb') : url('/images/avatar.jpg')  }}" alt="avatar" class="avatar rounded img-responsive mr-1">
                            {{ Auth::user()->name }}
                        </div>
                    @endauth
                </a>
            ...
            <li class="sidebarCollapse">
                <a href="#users" data-toggle="collapse" aria-expanded="false" class="arrow-toggle @if(\Request::route()->getName() == 'users' or \Request::route()->getName() == 'students') active @endif nav-link link-dark">
                ...
                <ul class="collapse lisst-unstyled @if(\Request::route()->getName() == 'users' or \Request::route()->getName() == 'students') show @endif p-0 m-1" id="users">
                    @can('view-user')
                        <li>
